            ...
            <v-col lg="6" sm="12" class="pl-lg-5">
                ...
                <v-row>
                    <v-col cols="6" sm="2" class="d-flex align-center">
                        <h6 class="text-h6">Colores<span class="text-error">*</span></h6>
                    </v-col>
                    <v-col cols="6" sm="10">
                ...
                <v-row class="mt-6">
                    ...
                    <v-col cols="12" sm="4">
                        <v-btn block size="large" color="secondary" @click="store.AddToCart(getProduct)">Agregar al carrito</v-btn>
                    </v-col>
                </v-row>
                <div class="mt-8">
                    <h6 class="text-subtitle-1">Tiempo de llagada: 2 - 3 semanas</h6>
                    <router-link to="/" class="text-subtitle-1 text-decoration-none">Por qué tarda ese tiempo la paqueteria?</router-link>
                </div>
            </v-col>
        </v-row>
    </div>
