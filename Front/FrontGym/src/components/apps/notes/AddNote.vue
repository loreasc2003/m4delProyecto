...
<template>
    ...
    <v-sheet>
        <v-btn color="primary" @click="dialog = true">Agregar programas</v-btn>

        <v-dialog v-model="dialog" max-width="500">
            <v-card>
                <v-card-text>
                    <h4 class="text-h6 mb-4">Agregar nota</h4>
                    <v-textarea outlined name="Note" v-model="title"></v-textarea>
                    <h4 class="text-h6 mt-4 mb-4">Selecciona el color de la nota</h4>
                ...
                <v-card-actions>
                    <v-btn color="primary" @click="addNote">Guardar</v-btn>
                    <v-btn color="primary" @click="dialog = false">Cancelar nota</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-sheet>
